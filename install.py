...
"""Copy the Despeckle extension into Inkscape's per-user extensions folder.
...
FILES = ("despeckle.py", "despeckle.inx")
...
def main():
    parser = argparse.ArgumentParser(description="Install the Despeckle Inkscape extension.")
    ...
    print("\nDone. Restart Inkscape, then use Extensions > Cleanup > "
          "Despeckle (Small Object Remover).")
